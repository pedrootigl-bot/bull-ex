...
import styles from "./ghostFibers.module.css";
...
const contexts = new WeakMap<HTMLElement, GhostFibersContext>();
...
export function GhostFibers({
  ...
  return <div ref={containerRef} className={`${styles.container} ${className}`.trim()} aria-hidden="true" />;
}
